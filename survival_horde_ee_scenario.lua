...
Survival Horde is made by Mikzau, EE changes by Entropy Wins.
  ...
  preview = '',
  size = {512, 512},
  map = '/maps/survival_horde_ee.v0016/survival_horde_ee.scmap',
  save = '/maps/survival_horde_ee.v0016/survival_horde_ee_save.lua',
  script = '/maps/survival_horde_ee.v0016/survival_horde_ee_script.lua',
  norushradius = 80,
  Configurations = {
    ['standard'] = {
      teams = {
